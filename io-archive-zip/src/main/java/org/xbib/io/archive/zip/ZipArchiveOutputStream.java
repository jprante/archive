...
import static org.xbib.io.archive.zip.ZipConstants.DATA_DESCRIPTOR_MIN_VERSION;
import static org.xbib.io.archive.zip.ZipConstants.DWORD;
import static org.xbib.io.archive.zip.ZipConstants.INITIAL_VERSION;
...
import static org.xbib.io.archive.zip.ZipConstants.ZIP64_MIN_VERSION;
 ...
 * #putArchiveEntry(ZipArchiveEntry)} can be called.
 * It transparently supports Zip64
...
public class ZipArchiveOutputStream<E extends ZipArchiveEntry> extends ArchiveOutputStream<E> {
     ...
     * <a href="http://java.sun.com/j2se/1.5.0/docs/guide/intl/encoding.doc.html">http://java.sun.com/j2se/1.5.0/docs/guide/intl/encoding.doc.html</a>
     * Defaults to UTF-8.
     *
     ...
     * encoding is UTF-8. Defaults to true.
     */
